  ...
  return (
    <div className="max-w-md w-full mx-auto">
      ...
      <p className="mt-2 text-center text-sm text-black-500 dark:text-white-300">
        Or{' '}
        <Link to="/auth/login" className="font-medium text-black-700 hover:text-black-900 dark:text-white-300 dark:hover:text-white-100 underline">
      ...
      <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
        <div className="space-y-4">
          <div>
            <label htmlFor="name" className="block text-sm font-medium text-black-700 dark:text-white-300 mb-1">
              Full Name
            </label>
            <input
              id="name"
          ...
          <div>
            <label htmlFor="confirm-password" className="block text-sm font-medium text-black-700 dark:text-white-300 mb-1">
              Confirm Password
            </label>
            <div className="relative">
              <input
